...
>
    ...
    <div class="bg-white rounded-lg shadow-xl p-6 z-50 max-w-md w-full">
        <h2 class="text-xl font-bold mb-4">¿Eliminar Etiqueta?</h2>
        <p class="text-gray-700 mb-6">¿Estás seguro de que deseas eliminar esta etiqueta? Esta acción no se puede deshacer.</p>
